...
const ChatWidget = () => {
  ...
  useEffect(() => {
    if (iframeRef.current) {
      const height = isOpen ? iframeRef.current.scrollHeight + 5 : 60;
      const width = isOpen ? iframeRef.current.scrollWidth + 5 : 60;
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="mt-2 w-[400px] h-[700px] bg-gray-50 rounded-2xl shadow-xl flex flex-col"
          >
